...
/***/ function(module, exports, __webpack_require__) {
	...
	var _t = __webpack_require__(181);
	...
	window.onload = function () {
	    _reactDom2.default.render(_react2.default.createElement(_t2.default), document.getElementById('conteiner'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var s = (0, _redux.createStore)(red);
	...
	var T = function (_React$Component) {
	    ...
	    _createClass(T, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            fetch('http://localhost:3002/notebooks/filter_fields').then(function (r) {
	                return r.json();
	            }).then(function (r) {
	                return _this2.setState({ arr: r });
	            });
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    null,
	                    this.state && this.state.arr[0].text || '111111'
	                ),
	                _react2.default.createElement(
	                    'div',
	                    null,
	                    this.state && this.state.a || '22222'
	                )
	            );
	        }
	    }]);
